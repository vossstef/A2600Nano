...
create_clock -name ds2_clk -period 8000 -waveform {0 5} [get_nets {gamepad_p1/clk_spi}]
create_clock -name ds_clk -period 8000 -waveform {0 5} [get_nets {gamepad_p2/clk_spi}]
